...
```
Modules/
├── Auth            → المصادقة، OTP، الأدوار، الصلاحيات، طلبات الترقية
├── Core            → التصنيفات، المواقع (دول/مدن)، الملفات المؤقتة
├── RealEstate      → العقارات، المواعيد، الخرائط، الإعلانات، البطاقات الإيجارية، التقييمات
...
├── Statistics      → لوحات الإحصائيات (تاجر/سوق/أدمن)
└── Ai              → البحث الذكي ومساعد الوصف (Kimi API)
```
